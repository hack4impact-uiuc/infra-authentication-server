...
The jwt_token carries information of the userID and role/title, and the front-end exchanges this token with the API in the back-end in exhcange for resources.
